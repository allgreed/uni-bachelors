...
#APP
# 8 "a.c" 1
	.intel_syntax noprefix;xor eax, eax;xor ebx, ebx;mov ecx, -1;znak:inc ecx;mov dl, [%edi + ecx];sub dl, 'A';cmp dl, 'Z' - 'A';setle bl;add eax, ebx;cmp dl, -'A';jne znak;lea %edi, [eax - 1];.att_syntax prefix;
# 0 "" 2
#NO_APP
	movl	%edi, -32(%ebp)
	.loc 1 37 0
...
.LASF9:
	.string	"__quad_t"
.LASF58:
	.string	"/home/allgreed/Desktop/studia/ako/4/4a"
.LASF31:
	.string	"_old_offset"
.LASF55:
	.string	"sys_nerr"
